...
from .configuration_live_qwen import LiveQwenConfig
...
def build_live_qwen(**kwargs):
    return build_live(config_class=LiveQwenConfig, model_class=LiveQwenForCausalLM, **kwargs)
